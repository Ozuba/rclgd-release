...
project = "rclgd"
copyright = (
    "2025-present Ozuba and rclgd contributors (MIT Licensed)"
)
author = "Ozuba"
...
ogp_site_name = "rclgd documentation"
...
supported_languages = {
    "en": "rclgd %s documentation in English",
}
...
html_context = {
    ...
    "github_user": "Ozuba",  # Username
    "github_repo": "rclgd",  # Repo name
    "github_version": "main",  # Version
    "conf_py_path": "/docs/",  # Path in the checkout to the docs root
    "godot_inject_language_links": True,
    "godot_docs_supported_languages": list(supported_languages.keys()),
    "godot_docs_title": supported_languages[language],
    "godot_docs_basepath": "https://rclgd.readthedocs.io/",
